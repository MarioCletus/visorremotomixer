...
import com.basculasmagris.visorremotomixer.view.activities.CancellableNavigationView;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final CancellableNavigationView navView;

  private ActivityMainBinding(@NonNull DrawerLayout rootView, @NonNull AppBarMainBinding appBarMain,
      @NonNull DrawerLayout drawerLayout, @NonNull CancellableNavigationView navView) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.nav_view;
      CancellableNavigationView navView = ViewBindings.findChildViewById(rootView, id);
      if (navView == null) {
        break missingId;
      }
