...
public class RoundListFragmentDirections private constructor() {
  private data class ActionRoundListFragmentToRemoteMixerFragment(
    public val tabletMixer: TabletMixer? = null,
    public val tipoRonda: Int = 0
  ) : NavDirections {
    public override val actionId: Int = R.id.action_round_list_fragment_to_remote_mixer_fragment
  ...
  public companion object {
    public fun actionRoundListFragmentToRemoteMixerFragment(tabletMixer: TabletMixer? = null,
        tipoRonda: Int = 0): NavDirections =
        ActionRoundListFragmentToRemoteMixerFragment(tabletMixer, tipoRonda)
  }
}
